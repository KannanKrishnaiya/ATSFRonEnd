...
export default function CurrentCDMLevel() {
  ...
  const [CurrentCDMLevelTrans, SetCurrentCDMLevelTrans] = useState([]);
  const [CurrentCDMLevelTransInput, setCurrentCDMLevelTransInput] = useState({
  ...
  async function fetchData() {
    ...
    GetCurrentCDMLevelAPI(Userdetails)
      .then((response) => {
        console.log("GetCurrentCDMLevelAPI allMachinesFree", response);

        SetCurrentCDMLevelTrans(response?.data.allMachinesFree);
        setIsLoading(false);
      })
      .catch((err) => {
        setIsLoading(false);
        ...
        {isLoading ? (
          ...
          <div className="DivDataTable">
            <ThemeProvider theme={theme}>
              <MUIDataTable
                title={"Current CDM Level"}
                data={CurrentCDMLevelTrans}
